                ...
                <?= $this->include('dashboard/template/topbar') ?>
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                     ...
                     <div class="card">
                        ...
                        <hr>
                           <form action="<?= base_url('kritik/update/'.$kritik->id_kritik) ?>" method="POST">
                           <?= csrf_field(); ?>
                           <input type="hidden" name="_method" value="PATCH">
                              <label for="floatingTextarea2">Komentar</label>
                              <div class="form-floating">
                                 <input class="form-control" name="isi" value="<?= $kritik->isi ?>" placeholder="Kritik Dan Saran" id="floatingTextarea2" style="height: 100px"></input>
                              </div>
                              <div class="form-group">
