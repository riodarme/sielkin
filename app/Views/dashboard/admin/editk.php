                ...
                <?= $this->include('dashboard/template/topbar') ?>
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                     ...
                     <div class="card">
                        ...
                        <hr>
                        <form action="<?= base_url('admin/updatek/'.$kegiatan->id_kegiatan)?>" method="POST">
                           <?= csrf_field(); ?>
                           <input type="hidden" name="_method" value="PATCH">
                              <label for="floatingTextarea2">Kegiatan</label>
                              <div class="mb-3">
                              <input type="text" name="nm_kegiatan" value="<?= $kegiatan->nm_kegiatan ?>" class="form-control" id="exampleFormControlInput1" placeholder="Input Kegiatan">
                              </div>
                              <div class="form-group">
