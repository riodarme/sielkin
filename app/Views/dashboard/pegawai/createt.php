                ...
                <?= $this->include('dashboard/template/topbar') ?>
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                     ...
                     <div class="card">
                        ...
                        <a href="<?= base_url('kegiatan') ?>" class="btn btn-warning btn-sm float-end"><i class="fas fa-arrow-circle-left mr-1"></i>Kembali</a>
                        </div>
                        <hr>
                           ...
                           <div class="col-sm-6">
                           <input type="number" name="target" class="form-control" placeholder="Jumlah Target">
                           </div>
                           </div>
                              <div class="form-group">
