                ...
                <?= $this->include('dashboard/template/topbar') ?>
                    <div class="d-sm-flex align-items-center justify-content-between mb-2">
                     ...
                     <div class="card">
                        ...
                        <a href="<?= base_url('kegiatan/harian') ?>" class="btn btn-danger btn-sm float-end"><i class="fas fa-arrow-circle-left mr-1"></i>Kembali</a>
                        </div>
                        <hr>
                           <form action="<?= base_url('/kegiatan/tambahh'); ?>" method="POST">
                           <?= csrf_field(); ?>
                           ...
                           <div class="col-sm-6">
                           <input type="number" name="jm_berkas" class="form-control" placeholder="Jumlah">
                           </div>
                           </div>
                              <div class="form-floating">
                                 <textarea class="form-control" name="lain" placeholder="Detail Kegiatan" id="floatingTextarea2" style="height: 100px"></textarea>
                              </div>
                              <div class="form-group">
